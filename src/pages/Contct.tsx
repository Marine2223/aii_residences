...
import { FiMail, FiPhone, FiMapPin, FiFacebook, FiInstagram, FiCheckCircle } from "react-icons/fi";
...
export default function Contact() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Simulation d’envoi (ici tu pourrais envoyer à ton backend plus tard)
    setIsSent(true);
        ...
        <div>
          <h2 className="text-3xl font-bold text-gray-900 mb-4">
            ...
            <span className="text-marine">
              Africaine des Infrastructures et des Investisseurs
            </span>
          </h2>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-4 mt-6">
              <a href="#" className="text-marine hover:text-lightorange text-2xl transition duration-300">
                <FiFacebook />
              </a>
              <a href="#" className="text-marine hover:text-lightorange text-2xl transition duration-300">
                <FiInstagram />
        ...
        >
          <div>
            ...
            <input
              ...
              className="w-full border border-gray-300 rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-marine"
              required
            />
          </div>
          ...
          <button
            type="submit"
            className="w-full bg-marine hover:bg-lightorange text-white hover:text-marine font-semibold py-3 rounded-lg transition duration-300"
          >
            Envoyer le message
          </button>
          ...
          {isSent && (
            <div className="absolute inset-0 flex flex-col items-center justify-center bg-white/90 rounded-2xl transition animate-fadeIn">
              <FiCheckCircle className="text-marine text-5xl mb-2 animate-bounce" />
              <p className="text-marine font-semibold text-lg">Message envoyé avec succès !</p>
            </div>
          )}
        </form>
      </div>
