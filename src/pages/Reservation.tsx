                        ...
                        <fieldset>
                            <div className="mt-6 flex items-start">
                                <input
                                    type="checkbox"
                                    name="navette"
                                    checked={form.navette}
                                    onChange={handleChange}
                                    id="navette"
                                    className="mt-1 w-4 h-4 text-lightorange border-gray-300 rounded focus:ring-lightorange"
                                />
                                <label htmlFor="navette" className="ml-3 text-sm text-gray-700">
                                    Je souhaite souscrire à une location de navette transport.
                                </label>
                            </div>
                        </fieldset>
                        ...
                        <fieldset>
                            <div className="mt-6 flex items-start">
                                <input
                                    ...
                                    className="mt-1 w-4 h-4 text-lightorange border-gray-300 rounded focus:ring-lightorange"
                                />
                                <label htmlFor="petitDejeuner" className="ml-3 text-sm text-gray-700">
                                    Je souhaite souscrire une option petit déjeuner tout le séjour.
                                </label>
                            </div>
                        </fieldset>
