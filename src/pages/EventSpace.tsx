...
import { Users, Briefcase, Heart, Utensils, Zap } from 'lucide-react'; // Icônes professionnelles
import bgImage from "../assets/espace.jpg"; // image principale (Héro)

// --- Données Statiques MISES À JOUR AVEC CHEMINS D'IMAGES ---
const EVENT_SPACES = [
  {
    icon: Users,
    ...
    imagePath: "/assets/event_venus.jpg", // CHEMIN D'IMAGE À VÉRIFIER
  },
  {
    icon: Briefcase,
    ...
    imagePath: "/assets/event_jupiter.jpg", // CHEMIN D'IMAGE À VÉRIFIER
  },
  {
    icon: Heart,
    ...
    imagePath: "../assets/espace2.jpg", // CHEMIN D'IMAGE À VÉRIFIER
  },
];
...
export default function EventSpace() {
  return (
    // Correction de 'pt' par 'pt-24' pour laisser l'espace à la Navbar fixe
    <div className=" pb-12 bg-gray-50 min-h-screen"> 
      
      {/* --- Section 1: Héro et Titre --- */}
      <div className="relative h-[100vh] md:h-[100vh] flex items-center justify-center text-white overflow-hidden">
        <div 
          className="absolute inset-0 bg-cover bg-center bg-fixed"
          // Utilisation de la variable importée pour l'image de fond
      ...
      {/* --- Section 2: Nos Espaces Clés (Cartes Animées) --- */}
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold text-marine text-center mb-10">
          Découvrez la Polyvalence de Nos Salles
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {EVENT_SPACES.map((space, index) => (
            <motion.div
              ...
              // Nouvelle classe pour un design orienté image
            ...
            >
                {/* 1. Bloc Image (Nouveau) */}
                <div className="relative h-48 overflow-hidden">
                    <img 
                        // Utilisation de imagePath
                        src={space.imagePath} 
                        alt={space.title}
                ...
                {/* 2. Contenu (Sous l'image) */}
                <div className="p-6">
                    <space.icon className="w-8 h-8 text-lightorange mb-2" />
                    <h3 className="text-xl font-bold text-marine mb-3">{space.title}</h3>
                    {/* H-16 supprimé pour laisser l'espace texte s'ajuster */}
      ...
      {/* --- Section 3: Services Complémentaires (inchangée) --- */}
...
// Composant utilitaire pour les pilules de service
