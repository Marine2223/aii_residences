...
import { motion, AnimatePresence, type Variants } from 'framer-motion'; // <-- IMPORT DE VARIANTS
...
type ImageName = 'bgImage' | 'espace1' | 'vue';


interface Slide {
  imageName: ImageName; // <-- Utilisation du type strict
  title: string;
  subtitle: string;
  buttonText: string;
  link: string;
...
// Définir les données du carrousel avec le type Slide[]
...
const IMAGE_MAP: Record<ImageName, string> = {
  bgImage: bgImage,
  espace1: espace1,
  vue: vue,
};
...
const textVariants: Variants = { 
  ...
  center: {
    ...
    transition: {
      delay: 0.5,
      duration: 0.8,
      ease: "easeOut" // 'easeOut' est supporté par Framer Motion
    }
  },
